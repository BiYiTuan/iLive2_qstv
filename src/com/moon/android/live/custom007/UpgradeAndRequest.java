...
public class UpgradeAndRequest {
	...
	public void sendRequest(){
		//请求升级消息
		String str1 = new Configs().new RequestUrl().UPGRADE + "appid="
		...
		//请求滚动信息
		String str2 = new Configs().new RequestUrl().APP_MSG + "appid="
				...
				if (!bool) {
					try{
						...
						if (!"".equals(str3) && null != str3) {
							...
							logger.i("Get app msg and send broadcast : "
									+ Configs.BroadCast.APP_GET_MSG);
						}
					}catch(Exception e){
						logger.e(e.toString());
					}
						...
						if ((localUpdateData != null)
							...
							if ((localUpdateData.getCode() != null)
								...
								if (null != localUpdateData) {
									...
									mContext.sendBroadcast(intent);
									logger.i("Get update msg and send broadcast : "
											+ Configs.BroadCast.UPDATE_MSG);
								}
							}
						} 
					}catch(Exception e){

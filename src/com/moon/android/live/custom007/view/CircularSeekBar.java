...
import com.moon.android.live.custom007.R.drawable;
...
public class CircularSeekBar extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		if(0 != volumePos % volumeDegree.length){
			...
			Bitmap bitmap = drawableToBitmap(getResources().getDrawable(R.drawable.l_p_volume_slient));	
		...
		Bitmap bitmap = drawableToBitmap(getResources().getDrawable(R.drawable.l_p_volume_dot));	
